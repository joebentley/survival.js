...
/*#__PURE__*/
function () {
  function Font(fontImage, canvasContext) {
  ...
  _createClass(Font, [{
    key: "generateCharacterCache",
    value: function generateCharacterCache() {
      ...
      try {
        for (var _iterator = CHARS.split(' ').entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var maskOutColor = function maskOutColor(imageData, color) {
  var getColorIndicesForCoord = function getColorIndicesForCoord(x, y, width) {
  ...
  for (var x = 0; x < imageData.width; ++x) {
    for (var y = 0; y < imageData.height; ++y) {
      var _getColorIndicesForCo = getColorIndicesForCoord(x, y, imageData.width),
          _getColorIndicesForCo2 = _slicedToArray(_getColorIndicesForCo, 4),
          redIndex = _getColorIndicesForCo2[0],
          greenIndex = _getColorIndicesForCo2[1],
          blueIndex = _getColorIndicesForCo2[2],
          alphaIndex = _getColorIndicesForCo2[3];

      var _ref = [imageData.data[redIndex], imageData.data[greenIndex], imageData.data[blueIndex]],
          red = _ref[0],
          green = _ref[1],
          blue = _ref[2];
...
var getMaskedCanvas = function getMaskedCanvas(image, color) {
...
function () {
  ...
  _createClass(Point, [{
    ...
    key: "fromGridToScreen",
    value: function fromGridToScreen(x, y) {
